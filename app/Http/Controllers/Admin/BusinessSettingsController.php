...
class BusinessSettingsController extends Controller
{
    ...
    public function payment_index()
    {
        ...
        $data_values = Setting::whereIn('settings_type', ['payment_config'])->whereIn('key_name', ['ssl_commerz','paypal','stripe','razor_pay','senang_pay','paytabs','paystack','enkpay','paymob_accept','paytm','flutterwave','liqpay','bkash','mercadopago'])->get();
